...
and [[Weaponmaster|Weaponmaster]], and must know at least **two** offensive (<span class='fu-off'></span>) spells.
...
cast this way **must be an offensive (<span class='fu-off'></span>) spell with a total MP cost equal to or lower
