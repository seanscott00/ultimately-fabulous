...
> **Requirements:** you must have mastered the [[Gourmet|Gourmet]] Class.
...
or spell (if able).
- Each of this **delicacy**'s targets suffers [[enraged|enraged]].
- Each of this **delicacy**'s targets suffers [[poisoned|poisoned]].
...
- Each of this **delicacy**'s targets recovers from [[dazed|dazed]], [[enraged|enraged]], and [[shaken|shaken]].
- Each of this **delicacy**'s targets recovers from [[poisoned|poisoned]], [[slow|slow]], and [[weak|weak]].
