...
You may perform the **Inventory** action and spend 3 Inventory Points to create a **firearm** weapon known as a **magicannon** (see below). The magicannon will crumble to pieces as soon as you create a new magicannon. When you create a magicannon, choose the type of damage it deals (**air**, **bolt**, **earth**, **fire**, **ice**, or **physical**).

> [!statblock|firearm] Magicannon _[DEX + INS] +1 ~ [HR + 10]_
> Two-handed ~ Ranged ~ No Qualities.

### Magispheres (Superior)

You develop three magisphere prototypes; each of them can replicate a spell chosen from the following lists: [[Elementalist#ELEMENTALIST SPELLS|Elementalist]], [[Entropist#ENTROPIST SPELLS|Entropist]] and [[Spiritist#SPIRITIST SPELLS|Spiritist]]. The spells you choose may come from the same list or different lists.
