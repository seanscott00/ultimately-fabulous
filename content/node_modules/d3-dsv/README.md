...
To use a different delimiter, such as “|” for pipe-separated values, use [d3.dsvFormat](README.md##dsvFormat):
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[parse](README.md##dsv_parse). Note: requires unsafe-eval [content security policy](README.md##content-security-policy).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[parseRows](README.md##dsv_parseRows).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[format](README.md##dsv_format).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[formatBody](README.md##dsv_formatBody).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[formatRows](README.md##dsv_formatRows).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[formatRow](README.md##dsv_formatRow).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)(",").[formatValue](README.md##dsv_formatValue).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[parse](README.md.md##dsv_parse). Note: requires unsafe-eval [content security policy](README.md.md##content-security-policy).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[parseRows](README.md.md##dsv_parseRows).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[format](README.md.md##dsv_format).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[formatBody](README.md.md##dsv_formatBody).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[formatRows](README.md.md##dsv_formatRows).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[formatRow](README.md.md##dsv_formatRow).
...
Equivalent to [dsvFormat](README.md.md##dsvFormat)("\t").[formatValue](README.md.md##dsv_formatValue).
...
Unlike [*dsv*.parseRows](README.md.md.md##dsv_parseRows), this method requires that the first line of the DSV content contains a delimiter-separated list of column names; these column names become the attributes on the returned objects. For example, consider the following CSV file:
...
If the column names are not unique, only the last value is returned for each name; to access all values, use [*dsv*.parseRows](README.md.md.md##dsv_parseRows) instead (see [example](https://observablehq.com/@d3/parse-csv-with-duplicate-column-names)).

If a *row* conversion function is not specified, field values are strings. For safety, there is no automatic conversion to numbers, dates, or other types. In some cases, JavaScript may coerce strings to numbers for you automatically (for example, using the `+` operator), but better is to specify a *row* conversion function. See [d3.autoType](README.md##autoType) for a convenient *row* conversion function that infers and coerces common types like numbers and strings.
...
Note: requires unsafe-eval [content security policy](README.md.md.md##content-security-policy).
...
Formats the specified array of object *rows* as delimiter-separated values, returning a string. This operation is the inverse of [*dsv*.parse](README.md.md.md##dsv_parse). Each row will be separated by a newline (`\n`), and each column within each row will be separated by the delimiter (such as a comma, `,`). Values that contain either the delimiter, a double-quote (`"`) or a newline will be escaped using double-quotes.
...
Equivalent to [*dsv*.format](README.md.md.md##dsv_format), but omits the header row. This is useful, for example, when appending rows to an existing file.
...
Formats the specified array of array of string *rows* as delimiter-separated values, returning a string. This operation is the reverse of [*dsv*.parseRows](README.md.md.md##dsv_parseRows). Each row will be separated by a newline (`\n`), and each column within each row will be separated by the delimiter (such as a comma, `,`). Values that contain either the delimiter, a double-quote (") or a newline will be escaped using double-quotes.
...
Given an *object* (or array) representing a parsed row, infers the types of values on the *object* and coerces them accordingly, returning the mutated *object*. This function is intended to be used as a *row* accessor function in conjunction with [*dsv*.parse](README.md.md.md##dsv_parse) and [*dsv*.parseRows](README.md##dsv_parseRow). For example, consider the following CSV file:
...
When used with [d3.csvParse](README.md##csvParse),
...
Automatic type inference is primarily intended to provide safe, predictable behavior in conjunction with [*dsv*.format](README.md.md.md##dsv_format) and [*dsv*.formatRows](README.md.md.md.md##dsv_formatRows) for common JavaScript types. If you need different behavior, you should implement your own row accessor function.

For more, see [the d3.autoType notebook](https://observablehq.com/@d3/d3-autotype).

### Content Security Policy

If a [content security policy](http://www.w3.org/TR/CSP/) is in place, note that [*dsv*.parse](README.md.md.md##dsv_parse) requires `unsafe-eval` in the `script-src` directive, due to the (safe) use of dynamic code generation for fast parsing. (See [source](https://github.com/d3/d3-dsv/blob/master/src/dsv.js).) Alternatively, use [*dsv*.parseRows](README.md.md.md##dsv_parseRows).
...
Equivalent to [dsv2dsv](README.md##dsv2dsv), but the [output delimiter](README.md##dsv2dsv_output_delimiter) defaults to the tab character (\t).

<a name="tsv2csv" href="#tsv2csv">#</a> <b>tsv2csv</b> [<i>options…</i>] [<i>file</i>]

Equivalent to [dsv2dsv](README.md##dsv2dsv), but the [input delimiter](README.md.md##dsv2dsv_output_delimiter) defaults to the tab character (\t).
...
Equivalent to [dsv2json](README.md##dsv2json).

<a name="tsv2json" href="#csv2json">#</a> <b>tsv2json</b> [<i>options…</i>] [<i>file</i>]

Equivalent to [dsv2json](README.md##dsv2json), but the [input delimiter](README.md##dsv2json_input_delimiter) defaults to the tab character (\t).
...
Equivalent to [json2dsv](README.md##json2dsv).

<a name="json2tsv" href="#json2tsv">#</a> <b>json2tsv</b> [<i>options…</i>] [<i>file</i>]

Equivalent to [json2dsv](README.md##json2dsv), but the [output delimiter](README.md##json2dsv_output_delimiter) defaults to the tab character (\t).
