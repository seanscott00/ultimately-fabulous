...
- [Upgrade Guide](README.md##upgrade-guide)
...
Check whether the `pathname` is an valid `path.relative()`d path according to the [convention](README.md##1-pathname-should-be-a-pathrelatived-pathname).
...
See the convention [here](README.md.md##1-pathname-should-be-a-pathrelatived-pathname) for details.
...
- `.addIgnoreFile()` is removed, see the [.addIgnoreFile](README.md##addignorefilepath) section for details.
