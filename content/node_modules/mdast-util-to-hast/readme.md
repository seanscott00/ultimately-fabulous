...
* [Examples](readme.md##examples)
  * [Example: supporting HTML in markdown naïvely](readme.md##example-supporting-html-in-markdown-na%C3%AFvely)
  * [Example: supporting HTML in markdown properly](readme.md##example-supporting-html-in-markdown-properly)
  * [Example: footnotes in languages other than English](readme.md##example-footnotes-in-languages-other-than-english)
  * [Example: supporting custom nodes](readme.md##example-supporting-custom-nodes)
* [Algorithm](readme.md##algorithm)
  * [Default handling](readme.md##default-handling)
  * [Fields on nodes](readme.md##fields-on-nodes)
* [CSS](readme.md##css)
