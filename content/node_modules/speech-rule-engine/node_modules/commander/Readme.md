...
- [Commander.js](Readme.md##commanderjs)
  - [Installation](Readme.md##installation)
  - [Quick Start](Readme.md##quick-start)
  - [Declaring _program_ variable](Readme.md##declaring-program-variable)
  - [Options](Readme.md##options)
    - [Common option types, boolean and value](Readme.md##common-option-types-boolean-and-value)
    - [Default option value](Readme.md##default-option-value)
    - [Other option types, negatable boolean and boolean|value](Readme.md##other-option-types-negatable-boolean-and-booleanvalue)
    - [Required option](Readme.md##required-option)
    - [Variadic option](Readme.md##variadic-option)
    - [Version option](Readme.md##version-option)
    - [More configuration](Readme.md##more-configuration)
    - [Custom option processing](Readme.md##custom-option-processing)
  - [Commands](Readme.md##commands)
    - [Command-arguments](Readme.md##command-arguments)
      - [More configuration](Readme.md##more-configuration-1)
      - [Custom argument processing](Readme.md##custom-argument-processing)
    - [Action handler](Readme.md##action-handler)
    - [Stand-alone executable (sub)commands](Readme.md##stand-alone-executable-subcommands)
    - [Life cycle hooks](Readme.md##life-cycle-hooks)
  - [Automated help](Readme.md##automated-help)
    - [Custom help](Readme.md##custom-help)
    - [Display help after errors](Readme.md##display-help-after-errors)
    - [Display help from code](Readme.md##display-help-from-code)
    - [.name](Readme.md##name)
    - [.usage](Readme.md##usage)
    - [.helpOption(flags, description)](Readme.md##helpoptionflags-description)
    - [.addHelpCommand()](Readme.md##addhelpcommand)
    - [More configuration](Readme.md##more-configuration-2)
  - [Custom event listeners](Readme.md##custom-event-listeners)
  - [Bits and pieces](Readme.md##bits-and-pieces)
    - [.parse() and .parseAsync()](Readme.md##parse-and-parseasync)
    - [Parsing Configuration](Readme.md##parsing-configuration)
    - [Legacy options as properties](Readme.md##legacy-options-as-properties)
    - [TypeScript](Readme.md##typescript)
    - [createCommand()](Readme.md##createcommand)
    - [Node options such as `--harmony`](#node-options-such-as---harmony)
    - [Debugging stand-alone executable subcommands](Readme.md##debugging-stand-alone-executable-subcommands)
    - [Display error](Readme.md##display-error)
    - [Override exit and output handling](Readme.md##override-exit-and-output-handling)
    - [Additional documentation](Readme.md##additional-documentation)
  - [Support](Readme.md##support)
    - [Commander for enterprise](Readme.md##commander-for-enterprise)
...
An option and its option-argument can be separated by a space, or combined into the same argument. The option-argument can follow the short option directly or follow an ``bash
serve -p 80
serve -p80
serve --port 80
serve --port=80
