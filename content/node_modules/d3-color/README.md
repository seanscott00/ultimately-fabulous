...
In addition to the ubiquitous and machine-friendly [RGB](README.md##rgb) and [HSL](README.md##hsl) color space, d3-color supports color spaces that are designed for humans:

* [CIELAB](README.md##lab) (*a.k.a.* “Lab”)
* [CIELCh<sub>ab</sub>](README.md##lch) (*a.k.a.* “LCh” or “HCL”)
* Dave Green’s [Cubehelix](README.md##cubehelix)
...
Parses the specified [CSS Color Module Level 3](http://www.w3.org/TR/css3-color/#colorunits) *specifier* string, returning an [RGB](README.md##rgb) or [HSL](README.md.md##hsl) color, along with [CSS Color Module Level 4 hex](https://www.w3.org/TR/css-color-4/#hex-notation) *specifier* strings. If the specifier was not valid, null is returned. Some examples:
...
Returns the [RGB equivalent](README.md.md.md##rgb) of this color. For RGB colors, that’s `this`.
...
An alias for [*color*.formatRgb](README.md##color_formatRgb).
...
If *r*, *g* and *b* are specified, these represent the channel values of the returned color; an *opacity* may also be specified. If a CSS Color Module Level 3 *specifier* string is specified, it is parsed and then converted to the RGB color space. See [color](README.md##color) for examples. If a [*color*](README.md.md##color) instance is specified, it is converted to the RGB color space using [*color*.rgb](README.md##color_rgb). Note that unlike [*color*.rgb](README.md.md##color_rgb) this method *always* returns a new instance, even if *color* is already an RGB color.
...
If *h*, *s* and *l* are specified, these represent the channel values of the returned color; an *opacity* may also be specified. If a CSS Color Module Level 3 *specifier* string is specified, it is parsed and then converted to the HSL color space. See [color](README.md##color) for examples. If a [*color*](README.md.md##color) instance is specified, it is converted to the RGB color space using [*color*.rgb](README.md##color_rgb) and then converted to HSL. (Colors already in the HSL color space skip the conversion to RGB.)
...
Equivalent to [d3.lch](README.md.md##lch), but with reversed argument order.
...
If *h*, *s* and *l* are specified, these represent the channel values of the returned color; an *opacity* may also be specified. If a CSS Color Module Level 3 *specifier* string is specified, it is parsed and then converted to the Cubehelix color space. See [color](README.md##color) for examples. If a [*color*](README.md.md##color) instance is specified, it is converted to the RGB color space using [*color*.rgb](README.md##color_rgb) and then converted to Cubehelix. (Colors already in the Cubehelix color space skip the conversion to RGB.)
