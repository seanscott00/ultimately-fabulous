...
> A tiny (183B to 210B) and [fast](readme.md##benchmarks) utility to ascend parent directories
...
**Notice:** As of v3.1.0, `escalade` now includes [Deno support](http://deno.land/x/escalade)! Please see [Deno Usage](readme.md##deno) below.
...
Please note that the [API](readme.md##api) is identical and that there are still [two modes](readme.md##modes) from which to choose:
