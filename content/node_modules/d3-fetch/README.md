...
This module has built-in support for parsing [JSON](README.md##json), [CSV](README.md##csv), and [TSV](README.md##tsv). You can parse additional formats by using [text](README.md##text) directly. (This module replaced [d3-request](https://github.com/d3/d3-request).)
...
Equivalent to [d3.dsv](README.md##dsv) with the comma character as the delimiter.
...
Equivalent to [d3.dsv](README.md##dsv) with the tab character as the delimiter.
