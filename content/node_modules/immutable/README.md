...
- [The case for Immutability](README.md##the-case-for-immutability)
- [JavaScript-first API](README.md##javascript-first-api)
- [Nested Structures](README.md##nested-structures)
- [Equality treats Collections as Values](README.md##equality-treats-collections-as-values)
- [Batching Mutations](README.md##batching-mutations)
- [Lazy Seq](README.md##lazy-seq)
- [Additional Tools and Resources](README.md##additional-tools-and-resources)
