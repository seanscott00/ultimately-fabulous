...
The easing types in this module implement the [ease method](README.md##ease_ease), which takes a normalized time *t* and returns the corresponding “eased” time *tʹ*. Both the normalized time and the eased time are typically in the range [0,1], where 0 represents the start of the animation and 1 represents the end; some easing types, such as [elastic](README.md##easeElastic), may return eased times slightly outside this range. A good easing type should return 0 if *t* = 0 and 1 if *t* = 1. See the [easing explorer](https://observablehq.com/@d3/easing) for a visual demonstration.
...
Polynomial easing; raises *t* to the specified [exponent](README.md##poly_exponent). If the exponent is not specified, it defaults to 3, equivalent to [cubicIn](README.md##easeCubicIn).
...
Reverse polynomial easing; equivalent to 1 - [polyIn](README.md##easePolyIn)(1 - *t*). If the [exponent](README.md##poly_exponent) is not specified, it defaults to 3, equivalent to [cubicOut](README.md##easeCubicOut).
...
Symmetric polynomial easing; scales [polyIn](README.md##easePolyIn) for *t* in [0, 0.5] and [polyOut](README.md##easePolyOut) for *t* in [0.5, 1]. If the [exponent](README.md##poly_exponent) is not specified, it defaults to 3, equivalent to [cubic](README.md.md##easeCubic).
...
Returns a new polynomial easing with the specified exponent *e*. For example, to create equivalents of [linear](README.md##easeLinear), [quad](README.md##easeQuad), and [cubic](README.md.md.md##easeCubic):
...
Quadratic easing; equivalent to [polyIn](README.md##easePolyIn).[exponent](README.md##poly_exponent)(2).
...
Reverse quadratic easing; equivalent to 1 - [quadIn](README.md##easeQuadIn)(1 - *t*). Also equivalent to [polyOut](README.md.md##easePolyOut).[exponent](README.md##poly_exponent)(2).
...
Symmetric quadratic easing; scales [quadIn](README.md##easeQuadIn) for *t* in [0, 0.5] and [quadOut](README.md##easeQuadOut) for *t* in [0.5, 1]. Also equivalent to [poly](README.md##easePoly).[exponent](README.md##poly_exponent)(2).
...
Cubic easing; equivalent to [polyIn](README.md##easePolyIn).[exponent](README.md##poly_exponent)(3).
...
Reverse cubic easing; equivalent to 1 - [cubicIn](README.md.md##easeCubicIn)(1 - *t*). Also equivalent to [polyOut](README.md.md.md##easePolyOut).[exponent](README.md##poly_exponent)(3).
...
Symmetric cubic easing; scales [cubicIn](README.md.md##easeCubicIn) for *t* in [0, 0.5] and [cubicOut](README.md.md##easeCubicOut) for *t* in [0.5, 1]. Also equivalent to [poly](README.md.md##easePoly).[exponent](README.md##poly_exponent)(3).
...
Reverse sinusoidal easing; equivalent to 1 - [sinIn](README.md##easeSinIn)(1 - *t*).
...
Symmetric sinusoidal easing; scales [sinIn](README.md##easeSinIn) for *t* in [0, 0.5] and [sinOut](README.md##easeSinOut) for *t* in [0.5, 1].
...
Reverse exponential easing; equivalent to 1 - [expIn](README.md##easeExpIn)(1 - *t*).
...
Symmetric exponential easing; scales [expIn](README.md##easeExpIn) for *t* in [0, 0.5] and [expOut](README.md##easeExpOut) for *t* in [0.5, 1].
...
Reverse circular easing; equivalent to 1 - [circleIn](README.md##easeCircleIn)(1 - *t*).
...
Symmetric circular easing; scales [circleIn](README.md##easeCircleIn) for *t* in [0, 0.5] and [circleOut](README.md##easeCircleOut) for *t* in [0.5, 1].
...
Elastic easing, like a rubber band. The [amplitude](README.md##elastic_amplitude) and [period](README.md##elastic_period) of the oscillation are configurable; if not specified, they default to 1 and 0.3, respectively.
...
Reverse elastic easing; equivalent to 1 - [elasticIn](README.md##easeElasticIn)(1 - *t*).
...
Symmetric elastic easing; scales [elasticIn](README.md##easeElasticIn) for *t* in [0, 0.5] and [elasticOut](README.md##easeElasticOut) for *t* in [0.5, 1].
...
[Anticipatory](https://en.wikipedia.org/wiki/12_basic_principles_of_animation#Anticipation) easing, like a dancer bending his knees before jumping off the floor. The degree of [overshoot](README.md##back_overshoot) is configurable; if not specified, it defaults to 1.70158.
...
Reverse anticipatory easing; equivalent to 1 - [backIn](README.md##easeBackIn)(1 - *t*).
...
Symmetric anticipatory easing; scales [backIn](README.md##easeBackIn) for *t* in [0, 0.5] and [backOut](README.md##easeBackOut) for *t* in [0.5, 1].
...
Reverse bounce easing; equivalent to 1 - [bounceIn](README.md##easeBounceIn)(1 - *t*).
...
Symmetric bounce easing; scales [bounceIn](README.md##easeBounceIn) for *t* in [0, 0.5] and [bounceOut](README.md##easeBounceOut) for *t* in [0.5, 1].
