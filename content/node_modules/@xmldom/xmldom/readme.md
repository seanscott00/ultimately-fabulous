...
When deciding how to fix bugs or implement features, `xmldom` tries to stay as close  as possible to the various [related specifications/standards](readme.md##specs).  
...
more details are available in the (incomplete) [API Reference](readme.md##api-reference) section.
