...
- [Demo \& API](README.md##demo--api)
- [FAQ](README.md##faq)
    - [Yet another fetch library?](README.md##yet-another-fetch-library)
    - [Why polyfill might not be a good idea?](README.md##why-polyfill-might-not-be-a-good-idea)
    - [How does cross-fetch work?](README.md##how-does-cross-fetch-work)
- [Who's Using It?](README.md##whos-using-it)
