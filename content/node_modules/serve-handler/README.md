...
Just like with [rewrites](README.md.md##rewrites-array), you can also use routing segments:
...
Either you disable the directory listing entirely (like shown [here](README.md.md##directorylisting-booleanarray)), or you exclude certain paths from those listings by adding them all to this config property.
