...
You can, however, use [d3.timeDay](README.md##timeDay).[count](README.md##interval_count):

```js
d3.timeDay.count(start, end) // 31 😌
```

The [day](README.md##day) [interval](README.md##api-reference) is one of several provided by d3-time. Each interval represents a conventional unit of time—[hours](README.md##timeHour), [weeks](README.md##timeWeek), [months](README.md##timeMonth), *etc.*—and has methods to calculate boundary dates. For example, [d3.timeDay](README.md##timeDay) computes midnight (typically 12:00 AM local time) of the corresponding day. In addition to [rounding](README.md##interval_round) and [counting](README.md.md##interval_count), intervals can also be used to generate arrays of boundary dates. For example, to compute each Sunday in the current month:
...
Equivalent to [*interval*.floor](README.md##interval_floor), except if *date* is not specified, it defaults to the current time. For example, [d3.timeYear](README.md##timeYear)(*date*) and d3.timeYear.floor(*date*) are equivalent.
...
Returns a new date representing the latest interval boundary date before or equal to *date*. For example, [d3.timeDay](README.md##timeDay).floor(*date*) typically returns 12:00 AM local time on the given *date*.
...
Returns a new date representing the closest interval boundary date to *date*. For example, [d3.timeDay](README.md##timeDay).round(*date*) typically returns 12:00 AM local time on the given *date* if it is on or before noon, and 12:00 AM of the following day if it is after noon.
...
Returns a new date representing the earliest interval boundary date after or equal to *date*. For example, [d3.timeDay](README.md##timeDay).ceil(*date*) typically returns 12:00 AM local time on the date following the given *date*.
...
Returns an array of dates representing every interval boundary after or equal to *start* (inclusive) and before *stop* (exclusive). If *step* is specified, then every *step*th boundary will be returned; for example, for the [d3.timeDay](README.md##timeDay) interval a *step* of 2 will return every other day. If *step* is not an integer, it is [floored](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/floor).

The first date in the returned array is the earliest boundary after or equal to *start*; subsequent dates are [offset](README.md##interval_offset) by *step* intervals and [floored](README.md.md##interval_floor). Thus, two overlapping ranges may be consistent. For example, this range contains odd days:
...
To make ranges consistent when a *step* is specified, use [*interval*.every](README.md##interval_every) instead.
...
The returned filtered interval does not support [*interval*.count](README.md.md.md##interval_count). See also [*interval*.every](README.md##interval_every).
...
Returns a [filtered](README.md##interval_filter) view of this interval representing every *step*th date. The meaning of *step* is dependent on this interval’s parent interval as defined by the field function. For example, [d3.timeMinute](README.md##timeMinute).every(15) returns an interval representing every fifteen minutes, starting on the hour: :00, :15, :30, :45, <i>etc.</i> Note that for some intervals, the resulting dates may not be uniformly-spaced; [d3.timeDay](README.md##timeDay)’s parent interval is [d3.timeMonth](README.md.md##timeMonth), and thus the interval number resets at the start of each month. If *step* is not valid, returns null. If *step* is one, returns this interval.

This method can be used in conjunction with [*interval*.range](README.md##interval_range) to ensure that two overlapping ranges are consistent. For example, this range contains odd days:
...
The returned filtered interval does not support [*interval*.count](README.md.md.md##interval_count). See also [*interval*.filter](README.md.md##interval_filter).
...
Returns the number of interval boundaries after *start* (exclusive) and before or equal to *end* (inclusive). Note that this behavior is slightly different than [*interval*.range](README.md##interval_range) because its purpose is to return the zero-based number of the specified *end* date relative to the specified *start* date. For example, to compute the current zero-based day-of-year number:
...
The optional *count* function takes a start date and an end date, already floored to the current interval, and returns the number of boundaries between the start (exclusive) and end (inclusive). If a *count* function is not specified, the returned interval does not expose [*interval*.count](README.md.md.md##interval_count) or [*interval*.every](README.md##interval_every) methods. Note: due to an internal optimization, the specified *count* function must not invoke *interval*.count on other time intervals.

The optional *field* function takes a date, already floored to the current interval, and returns the field value of the specified date, corresponding to the number of boundaries between this date (exclusive) and the latest previous parent boundary. For example, for the [d3.timeDay](README.md##timeDay) interval, this returns the number of days since the start of the month. If a *field* function is not specified, it defaults to counting the number of interval boundaries since the UNIX epoch of January 1, 1970 UTC. The *field* function defines the behavior of [*interval*.every](README.md##interval_every).
...
Days (e.g., February 7, 2012 at 12:00 AM); typically 24 hours. Days in local time may range from 23 to 25 hours due to daylight saving. d3.unixDay is like [d3.utcDay](README.md.md.md.md.md.md.md.md.md.md##timeDay), except it counts days since the UNIX epoch (January 1, 1970) such that *interval*.every returns uniformly-spaced dates rather than varying based on day-of-month.
...
Alias for [d3.timeSunday](README.md##timeSunday); 7 days and typically 168 hours. Weeks in local time may range from 167 to 169 hours due to daylight saving.
...
For convenience, aliases for [*interval*.range](README.md##interval_range) are also provided as plural forms of the corresponding interval.
...
Aliases for [d3.timeMillisecond](README.md##timeMillisecond).[range](README.md.md.md.md##interval_range) and [d3.utcMillisecond](README.md.md##timeMillisecond).[range](README.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeSecond](README.md##timeSecond).[range](README.md.md.md.md.md.md##interval_range) and [d3.utcSecond](README.md.md##timeSecond).[range](README.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeMinute](README.md.md##timeMinute).[range](README.md.md.md.md.md.md.md.md##interval_range) and [d3.utcMinute](README.md.md.md##timeMinute).[range](README.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeHour](README.md.md##timeHour).[range](README.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcHour](README.md.md.md##timeHour).[range](README.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeDay](README.md##timeDay).[range](README.md.md.md.md.md.md.md.md.md.md.md.md##interval_range), [d3.utcDay](README.md.md.md.md.md.md.md.md.md.md##timeDay).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range), and [d3.unixDay](README.md.md.md.md.md.md.md.md.md.md.md.md.md##timeDay).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeWeek](README.md.md##timeWeek).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcWeek](README.md.md.md##timeWeek).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeSunday](README.md##timeSunday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcSunday](README.md.md.md##timeSunday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeMonday](README.md##timeMonday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcMonday](README.md.md##timeMonday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeTuesday](README.md##timeTuesday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcTuesday](README.md.md##timeTuesday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeWednesday](README.md##timeWednesday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcWednesday](README.md.md##timeWednesday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeThursday](README.md##timeThursday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcThursday](README.md.md##timeThursday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeFriday](README.md##timeFriday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcFriday](README.md.md##timeFriday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeSaturday](README.md##timeSaturday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcSaturday](README.md.md##timeSaturday).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeMonth](README.md.md.md##timeMonth).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcMonth](README.md.md.md.md##timeMonth).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Aliases for [d3.timeYear](README.md.md##timeYear).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range) and [d3.utcYear](README.md.md.md##timeYear).[range](README.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md.md##interval_range).
...
Equivalent to [d3.utcTicks](README.md##utcTicks), but in local time.
...
Returns the time interval that would be used by [d3.timeTicks](README.md##timeTicks) given the same arguments.
...
If *count* is a time interval, this function behaves similarly to [*interval*.range](README.md##interval_range) except that both *start* and *stop* are inclusive and it may return dates in reverse chronological order if *stop* is before *start*.
...
Returns the time interval that would be used by [d3.utcTicks](README.md##utcTicks) given the same arguments. If there is no associated interval, such as when *start* or *stop* is invalid, returns null.
