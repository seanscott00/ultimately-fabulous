...
- 📦 **Small**: Just **1.7 KB** gzipped ([3x+ lighter](README.md##benchmarks) than **color** and **tinycolor2**)
- 🚀 **Fast**: [3x+ faster](README.md.md##benchmarks) than **color** and **tinycolor2**
- 😍 **Simple**: Chainable API and familiar patterns
- 💪 **Immutable**: No need to worry about data mutations
- 🛡 **Bulletproof**: Written in strict TypeScript and has 100% test coverage
- 🗂 **Typed**: Ships with [types included](README.md##types)
- 🏗 **Extendable**: Built-in [plugin system](README.md##plugins) to add new functionality
...
- HSV objects
- Color names ([via plugin](README.md.md##plugins))
- HWB objects and strings ([via plugin](README.md.md##plugins))
- CMYK objects and strings ([via plugin](README.md.md##plugins))
- LCH objects and strings ([via plugin](README.md.md##plugins))
- LAB objects ([via plugin](README.md.md##plugins))
- XYZ objects ([via plugin](README.md.md##plugins))
...
Check out the ["Plugins"](README.md.md.md.md.md.md.md.md##plugins) section for more input format examples.
