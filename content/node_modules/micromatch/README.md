...
- [Sponsors](README.md##sponsors)
  * [Gold Sponsors](README.md##gold-sponsors)
  * [Quickstart](README.md##quickstart)
  * [Why use micromatch?](README.md##why-use-micromatch)
    + [Matching features](README.md##matching-features)
  * [Switching to micromatch](README.md##switching-to-micromatch)
    + [From minimatch](README.md##from-minimatch)
    + [From multimatch](README.md##from-multimatch)
  * [API](README.md##api)
  * [Options](README.md##options)
  * [Options Examples](README.md##options-examples)
    + [options.basename](README.md##optionsbasename)
    + [options.bash](README.md##optionsbash)
    + [options.expandRange](README.md##optionsexpandrange)
    + [options.format](README.md##optionsformat)
    + [options.ignore](README.md##optionsignore)
    + [options.matchBase](README.md##optionsmatchbase)
    + [options.noextglob](README.md##optionsnoextglob)
    + [options.nonegate](README.md##optionsnonegate)
    + [options.noglobstar](README.md##optionsnoglobstar)
    + [options.nonull](README.md##optionsnonull)
    + [options.nullglob](README.md##optionsnullglob)
    + [options.onIgnore](README.md##optionsonignore)
    + [options.onMatch](README.md##optionsonmatch)
    + [options.onResult](README.md##optionsonresult)
    + [options.posixSlashes](README.md##optionsposixslashes)
    + [options.unescape](README.md##optionsunescape)
  * [Extended globbing](README.md##extended-globbing)
    + [Extglobs](README.md##extglobs)
    + [Braces](README.md##braces)
    + [Regex character classes](README.md##regex-character-classes)
    + [Regex groups](README.md##regex-groups)
    + [POSIX bracket expressions](README.md##posix-bracket-expressions)
  * [Notes](README.md##notes)
    + [Bash 4.3 parity](README.md##bash-43-parity)
    + [Backslashes](README.md##backslashes)
  * [Benchmarks](README.md##benchmarks)
    + [Running benchmarks](README.md##running-benchmarks)
    + [Latest results](README.md##latest-results)
...
The [main export](README.md##micromatch) takes a list of strings and one or more glob patterns:
...
Use [.isMatch()](README.md##ismatch) to for boolean matching:
...
[Switching](README.md.md##switching-to-micromatch) from minimatch and multimatch is easy!

<br>

## Why use micromatch?

> micromatch is a [replacement](README.md.md.md##switching-to-micromatch) for minimatch and multimatch

* Supports all of the same matching features as [minimatch](https://github.com/isaacs/minimatch) and [multimatch](https://github.com/sindresorhus/multimatch)
* More complete support for the Bash 4.3 specification than minimatch and multimatch. Micromatch passes _all of the spec tests_ from bash, including some that bash still fails.
* **Fast & Performant** - Loads in about 5ms and performs [fast matches](README.md.md##benchmarks).
* **Glob matching** - Using wildcards (`*` and `?`), globstars (`**`) for nested directories
* **[Advanced globbing](README.md.md##extended-globbing)** - Supports [extglobs](README.md.md##extglobs), [braces](README.md##braces-1), and [POSIX brackets](README.md.md##posix-bracket-expressions), and support for escaping special characters with `\` or quotes.
...
* Wildcards (`**`, `*.js`)
* Negation (`'!a/*.js'`, `'*!(b).js'`)
* [extglobs](README.md.md.md##extglobs) (`+(x|y)`, `!(a|b)`)
* [POSIX character classes](README.md.md.md##posix-bracket-expressions) (`[[:alpha:][:digit:]]`)
...
_(There is one notable difference between micromatch and minimatch in regards to how backslashes are handled. See [the notes about backslashes](README.md.md##backslashes) for more information.)_

### From minimatch

Use [micromatch.isMatch()](README.md.md##ismatch) instead of `minimatch()`:

```js
console.log(micromatch.isMatch('foo', 'b*')); //=> false
```

Use [micromatch.match()](README.md##match) instead of `minimatch.match()`:
...
* `options` **{Object}**: See available [options](README.md.md##options)
...
* `options` **{Object}**: See available [options](README.md.md##options) for changing how matches are performed
...
Returns true if the given `string` contains the given pattern. Similar to [.isMatch](README.md##isMatch) but the pattern can match any part of the string.
...
```js
console.log(micromatch.isMatch('a1', '[[:alpha:][:digit:|:alpha:][:digit:]]')) //=> true
console.log(micromatch.isMatch('a1', '[[:alpha:][:alpha:|:alpha:][:alpha:]]')) //=> false
```
...
Released under the [MIT License](../ms/license.md#).
