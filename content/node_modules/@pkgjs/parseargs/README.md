...
- [Version Matchups](README.md##version-matchups)
- [🚀 Getting Started](README.md##-getting-started)
- [🙌 Contributing](README.md##-contributing)
- [💡 `process.mainArgs` Proposal](#-processmainargs-proposal)
  - [Implementation:](README.md##implementation)
- [📃 Examples](README.md##-examples)
- [F.A.Qs](README.md##faqs)
- [Links & Resources](README.md##links--resources)
...
Any person who wants to contribute to the initiative is welcome! Please first read the [Contributing Guide](../../mathjax-full/CONTRIBUTING.md#)
