...
- [256/Truecolor color support](readme.md##256-and-truecolor-color-support)
...
Chain [styles](readme.md##styles) and call the last one as a method with a string argument. Order doesn't matter, and later styles take precedent in case of a conflict. This simply means that `chalk.red.yellow.green` is equivalent to `chalk.green`.
