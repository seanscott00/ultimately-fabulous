...
- [[./features/Folder and Tag Listings|Folder and tag listings]] have also changed.
...
- If you customized the layout of Quartz 3, you may need to translate these changes from Go templates back to JSX as Quartz 4 no longer uses Hugo. For components, check out the guide on [[./advanced/Creating your own Quartz components|Creating your own Quartz components]] for more details on this.
