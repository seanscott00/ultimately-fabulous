...
| Layout                          | Preview                             |
| ------------------------------- | ----------------------------------- |
| Desktop (width > 1200px)        | ![[./images/quartz-layout-desktop.png\|800]] |
| Tablet (800px < width < 1200px) | ![[./images/quartz-layout-tablet.png\|800]]  |
| Mobile (width < 800px)          | ![[./images/quartz-layout-mobile.png\|800]]  |
...
See [a list of all the components](./tags/Components.md#) for all available components along with their configuration options. You can also checkout the guide on [[./advanced/Creating your own Quartz components|Creating your own Quartz components]] if you're interested in further customizing the behaviour of Quartz.
