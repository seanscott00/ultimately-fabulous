...
A lot of social media platforms can display a rich preview for your website when sharing a link (most notably, a cover image, a title and a description). Quartz automatically handles most of this for you with reasonable defaults, but for more control, you can customize these by setting [[Social Media Preview Cards#Frontmatter Properties|social images > Frontmatter Properties]].
...
| Light                               | Dark                               |
| ----------------------------------- | ---------------------------------- |
| ![[../images/social-image-preview-light.png|social-image-preview-light.png]] | ![[../images/social-image-preview-dark.png|social-image-preview-dark.png]] |

For testing, it is recommended to use [opengraph.xyz](https://www.opengraph.xyz/) to see what the link to your page will look like on various platforms (more info under [[Social Media Preview Cards#local testing|social images > local testing]]).
...
| Light                                      | Dark                                      |
| ------------------------------------------ | ----------------------------------------- |
| ![[../images/custom-social-image-preview-light.png|custom-social-image-preview-light.png]] | ![[../images/custom-social-image-preview-dark.png|custom-social-image-preview-dark.png]] |

This example (and the default template) use colors and fonts from your theme specified in the quartz config. Fonts get passed in as a prop, where `fonts[0]` will contain the header font and `fonts[1]` will contain the body font (more info in the [[Social Media Preview Cards#fonts|fonts]] section).
